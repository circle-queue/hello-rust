...
sample_input1 = sample_input2 = """467..114..
...*......
..35..633.
......#...
617*......
    ...
    for i, row in enumerate(input):
        for j, c in enumerate(row):
            if c.isdigit() or c == ".":
                continue
            valid_cells |= {
                (i_, j_) for i_ in range(i - 1, i + 2) for j_ in range(j - 1, j + 2)
            }

    valid_nums = []
    for i, row in enumerate(input):
        for nums_span in re.finditer(r"\d+", row):
            for j in range(*nums_span.span()):
                if is_valid := (i, j) in valid_cells:
                    break
            else:
                continue
            assert is_valid

            valid_nums.append(int(nums_span.group()))

    return str(sum(valid_nums))


def solve2(input: list[str]) -> str:
    valid_nums = collections.defaultdict(list)
    for i, row in enumerate(input):
        for nums_span in re.finditer(r"\d+", row):
            j_start, j_end = nums_span.span()
            for i_, j_ in (
                (i_, j_)
                for i_ in range(i - 1, i + 2)
                for j_ in range(j_start - 1, j_end + 1)
            ):
                valid_nums[i_, j_].append(int(nums_span.group()))

    gear_ratios = 0
    for i, row in enumerate(input):
        for j, c in enumerate(row):
            adj_nums = valid_nums[i, j]
            if c != "*" or len(adj_nums) != 2:
                continue
            a, b = adj_nums
            gear_ratios += a * b
...
full_input1 = full_input2 = """..........................380.......................143............................108.............630...........425........................
...
.........................610.26.............892...............................299............601............721..729........................""".splitlines()
