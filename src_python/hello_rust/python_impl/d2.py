...
def solve1(input: list[str]) -> str:
    ...
    for i, line in enumerate(input, start=1):
        ...
        for draw in line.split("; "):
            ...
            if any(n > total[color] for color, n in c.items()):
...
def solve2(input: list[str]) -> str:
    ...
    for line in input:
        ...
        for draw in line.split("; "):
            for item in draw.split(", "):
                n, color = item.split()
                c[color] = max(int(n), c[color])
        valid += reduce(int.__mul__, c.values())

    return str(valid)


sample_input1 = sample_input2 = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green""".splitlines()

full_input1 = full_input2 = """Game 1: 5 red, 1 green; 6 red, 3 blue; 9 red; 1 blue, 1 green, 4 red; 1 green, 2 blue; 2 blue, 1 red
...
Game 100: 10 blue, 5 green; 4 green, 3 red, 6 blue; 2 green, 4 red, 1 blue""".splitlines()
